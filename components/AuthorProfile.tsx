...
import { Author } from "@/store/models.type";
...
export default function AuthorProfile({ user }: { user: Author }) {
  ...
  const [userData, setUserData] = useState({
    ...
    description: user?.author_description || "",
    ...
    profile_image: user?.author_image || "",
  });
  ...
  const profileFields = [
    ...
    },
    {
      ...
      label: t("facebook"),
      value: userData.social_links.author_facebook,
      hasEdit: true,
    ...
    },
    {
      ...
      label: t("youtube"),
      value: userData.social_links.author_youtube,
      hasEdit: true,
    ...
    },
    {
      ...
      label: t("telegram"),
      value: userData.social_links.author_telegram,
      hasEdit: true,
    ...
    },
    {
      ...
      label: t("whatsapp"),
      value: userData.social_links.author_whatsapp,
      hasEdit: true,
    ...
    },
    {
      ...
      label: t("instagram"),
      value: userData.social_links.author_instagram,
      hasEdit: true,
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <EditFacebookModal
        ...
        currentFacebook={userData.social_links.author_facebook}
      ...
      <EditYoutubeModal
        ...
        currentYoutube={userData.social_links.author_youtube}
      ...
      <EditTelegramModal
        ...
        currentTelegram={userData.social_links.author_telegram}
      ...
      <EditWhatsappModal
        ...
        currentWhatsapp={userData.social_links.author_whatsapp}
      ...
      <EditInstagramModal
        ...
        currentInstagram={userData.social_links.author_instagram}
